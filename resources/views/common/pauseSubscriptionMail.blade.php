                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:60px 70px;">
                                        <h1 style="margin-bottom:30px;font-size:36px;text-align:left;color:#03696D;font-family: 'Inter', sans-serif;font-weight: 700;">Taking <br> a breeaak!</h1>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;text-align: left;">
                                            No problem!
                                            <br>
                                            <br>
                                            Your request to pause your meal plan has been received and is being processed.
                                            <br>
                                            <br>
                                            There will be no food production and delivery until you decide to reactivate your plan.
                                            <br>
                                            <br>
                                            In case you reconsider pausing your meal plan, click the link below and select your daily meal choice.

                                        </p>
                                        {{-- <a href="javascript:void(0);"
                                            style="background:#E4EFEE;text-decoration:none !important; font-weight:700; margin-top:20px;margin-bottom: 20px; color:#03696D;text-transform:uppercase; font-size:14px;padding:10px 24px;display:block;border-radius:50px;width: 40%;font-family: 'Open Sans'">DAILY MEAL
                                        </a> --}}
