            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		<td style="padding: 0 2.5em; text-align: left;">
            			<div class="text">
            				<h2>Your Selected Meals are here...</h2>
	      ...
	      <tr>
	      	<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
	      		<tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
					    <th width="50%" style="text-align:left; padding: 0 2.5em; color: #000; padding-bottom: 20px">Date</th>
					    ...
					    <th width="20%" style="text-align:right; padding: 0 2.5em; color: #000; padding-bottom: 20px">Type</th>
					  </tr>
					  ...
					  <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
					  	...
					  	<td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
					  		<!-- <div class="product-entry"> -->
					  			<img src="{{"https://freshly.luckistore.in/images/api_images"}}/{{ $meal['meal_image'] }}" alt="" style="width: 70px; max-width: 300px; height: auto; margin-bottom: 20px; display: block;">
					  		<!-- </div> -->
					  	</td>
