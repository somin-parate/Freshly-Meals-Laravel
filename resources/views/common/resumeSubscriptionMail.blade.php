                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:60px 70px;">
                                        <h1 style="margin-bottom:30px;font-size:36px;text-align:left;color:#03696D;font-family: 'Inter', sans-serif;font-weight: 700;">Yay! <br> You’re back.</h1>
                                        ...
                                        <tr>
                                          <td>
                                            <h1 style="margin-bottom:20px;font-size:18px;text-align:center;color:#000;font-family: 'Inter', sans-serif;font-weight: 700;">Your Plan</h1>
                                        </td>
                                        </tr>
                    <tr>
                        <td>
