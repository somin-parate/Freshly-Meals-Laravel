                ...
                <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%";background-image:"https://designmodo.com/demo/emailtemplate/images/header-background.jpg" border="0"
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="text-align:center;">
                                        <h1 style="max-width:560px;font-family: 'Rubik',sans-serif;font-size:30px;font-weight: 400;color: #FFF;background-color:#03696D;margin: 0 auto;padding: 40px 0;border-radius: 8px;">FRESHLY MEALS</h1>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:60px 70px;">
                                        <h1 style="margin-bottom:30px;font-size:36px;text-align:left;color:#03696D;font-family: 'Inter', sans-serif;font-weight: 700;">Grrr...<br> Invalid code.</h1>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;text-align: left;">
                                            There seems to be an issue authenticating your verification code.
                                            <br>
                                            <br>
                                            Please verify your email address by confirming the verification code below.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                style="max-width:560px;background:#fff; border-radius:8px; text-align:center;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);">
                                <tr>
                                    <td style="padding:10px 20px 50px 20px;">
                                        <span style="border: 3px solid #03696D; border-radius: 50%; background-color: #03696d; padding: 15px 17px; margin-left: 5px; color: #fff;"> {{$otp[0]}} </span>
                                        <span style="border: 3px solid #03696D; border-radius: 50%; background-color: #03696d; padding: 15px 17px; margin-left: 5px; color: #fff;"> {{$otp[1]}} </span>
                                        <span style="border: 3px solid #03696D; border-radius: 50%; background-color: #03696d; padding: 15px 17px; margin-left: 5px; color: #fff;"> {{$otp[2]}} </span>
                                        <span style="border: 3px solid #03696D; border-radius: 50%; background-color: #03696d; padding: 15px 18px; margin-left: 5px; color: #fff;"> {{$otp[3]}} </span>
                                    </td>
                                </tr>
                            </table>
                    </tr>
