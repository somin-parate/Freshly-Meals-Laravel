                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:60px 70px;">
                                        <h1 style="margin-bottom:30px;font-size:36px;text-align:left;color:#03696D;font-family: 'Inter', sans-serif;font-weight: 700;">Change<br> starts within.</h1>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;text-align: left;">
                                            We’re so glad to have you onboard and are looking forward to creating healthier vibes with you.
                                            <br>
                                            <br>
                                            Your customer account has been created. You can now login at any time to manage your health and wellness journey seamlessly. Your profile includes your order history, special offers, and promotions.
                                            <br>
                                            <br>
                                            To access your account, click the link below.
                                        </p>
                                        <a href="javascript:void(0);"
                                            style="background:#E4EFEE;text-decoration:none !important; font-weight:700; margin-top:20px;margin-bottom: 20px; color:#03696D;text-transform:uppercase; font-size:14px;padding:10px 24px;display:block;border-radius:50px;width: 40%;font-family: 'Open Sans'">Login
                                        </a>
